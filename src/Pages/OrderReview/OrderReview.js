            ...
            <Grid container spacing={2} columns={{ xs: 12, sm: 6, md: 6 }}>
                                        ...
                                        <Grid item xs={2} sm={4} md={5} pl={2} my={3}>
                                            <Box style={{textAlign:"left"}}>
                                                ...
                                                <Typography variant="body">
                                                    <span style={{ fontWeight: 700,color:"white" }}>  Product: </span>
                                                    <span style={{color:"white"}}> {cart?.productName}</span>

                                                </Typography>
                                                <br />
                                                <Typography variant="body">
                                                    <span style={{ fontWeight: 700,color:"white" }}> Price:</span>
                                                    <span style={{color:"white"}}> {cart?.ProductPrice}</span>
                                                    {/* {cart?.ProductPrice} */}
                                                </Typography>
                                                <br />
                                                <Typography variant="body">
                                                    <span style={{ fontWeight: 700,color:"white" }}> Quantity:</span>
                                                    <span style={{color:"white"}}> {cart?.quantity}</span>
                                                    {/* {cart?.quantity} */}
                                                </Typography>
                                            ...
                                            <Button style={{textAlign:"left", marginLeft:"-120px", color:"white"}}
                ...
                <Grid item xs={12} sm={3} md={3} style={{backgroundColor:"white"}}>
                    ...
                    <Cart style={{backgroundColor:"#032831"}}>
                        <Button onClick={handlePaymentGoToPage} sx={{ width: 1, backgroundColor:"#032831",color:"white",marginRight:"10px"}}>Order Now</Button>
                    </Cart>
                </Grid>
            </Grid>
        </Container>
