...
const Electricaldrill = () => {
  ...
  const managePost = model?.filter(
    (models) =>
      models?.categories === "electricdrill" || models.role === "admin",
  );
  console.log(model);
  ...
  const placeholder = "Search by ElectricalDill Product Name";
  return (
    <div>
      {/* <Header></Header> */}
          ...
          <div className="row g-4">
            <div className="col-12">
              <div className="question-sidebar">
                <form onChange={(e) => setType(e.target.value)}></form>
              </div>
            </div>
            <div className="">
              {/* <div className="row"> */}
...
export default Electricaldrill;
