      ...
      <div style={{background:"black"}}>
        ...
        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12, lg: 12 }} sx={{mt:3}}>
          ...
          <Grid item xs={4} sm={4} md={7} lg={7}>
            <Box sx={{ mb: 5 }}>
              <Box style={{marginTop:"80px"}}>
                <Typography className='text-white' sx={{ mb: 2, fontWeight:"700", fontSize:"35px" }} variant='h4'>Get in Touch</Typography>
                <Typography className='text-white' sx={{ mb: 4,fontWeight:"700", fontSize:"20px"  }} variant='body'>You can find out any information about e-commerce in this website.If you have any question or confusion! Don't be shy. Feel free to connect with us. We are waitting for your response.</Typography>
          ...
          <Grid container spacing={{ xs: 2, md: 3, lg: 3 }} columns={{ xs: 4, sm: 8, md: 12, lg: 12 }}>
            ...
            <Grid item xs={2} sm={4} md={3} lg={3}>
              <Box>
                ...
                <Box>
                  ...
                  <Typography variant='body' style={{color:"white"}}>nahid@gmail.com</Typography><br />
                  <Typography variant='body' style={{color:"white"}}>nahid@gmail.com</Typography>
            ...
            <Grid item xs={2} sm={4} md={3} lg={3}>
              <Box>
                ...
                <Box>
                  ...
                  <Typography variant='body' style={{color:"white"}}>+880179689</Typography><br />
                  <Typography variant='body' style={{color:"white"}}>+880179677</Typography>
                </Box>
            ...
            <Grid item xs={2} sm={4} md={3} lg={3}>
              <Box>
                ...
                <Box>
                  <Typography sx={{ ml: 2 }} variant='h5' style={{color:"white"}}>Opening Hours</Typography>
                  <Typography variant='body' style={{color:"white"}}>Mon - Fri : 10am to 2pm</Typography><br />
                  <Typography variant='body' style={{color:"white"}}>Sat - Sun : Closed</Typography>
                </Box>
