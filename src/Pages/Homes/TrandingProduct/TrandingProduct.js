...
const TrandingProduct = ({ portfolio }) => {
    ...
    return (
        <Grid item xs={12} sm={12} md={4} data-aos={aos} data-aos-duration="2000">
            ...
            <h6 className="tittles" style={{fontStyle: 'italic'}}> Sale</h6>
                ...
                <Box className="overlay">
                    <Box className="portfolioContent">
                        ...
                        <Typography variant="p" sx={{ color: 'yellow', fontSize: 10 }}>
                            <span className='font-bold text-green-400' style={{fontStyle: 'italic'}}>Implements By:</span> {description.slice(0, 100)}
                        </Typography>
