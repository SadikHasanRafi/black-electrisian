...
const TrandingData = () => {
    ...
    const portfolios = [
        {
            id: 0,
            img_1: 'https://www.insideadvisorpro.com/wp-content/uploads/2022/10/IAP_Blog_ElectricalTools_The-Ultimate-Electrical-Apprentice-Tools-List.jpg',
            ...
            title: 'Screwdrivers',
            description: "Electrical equipment means any apparatus, appliance, cable, conductor, fitting, insulator, material,",
        ...
        {
            id: 1,
            img_1: 'https://www.theengineerspost.com/wp-content/uploads/2022/09/Tape-Measure.jpg?ezimgfmt=rs:279x259/rscb19/ngcb19/notWebP',
        ...
        {
            id: 2,
            img_1: 'https://housing.com/news/wp-content/uploads/2023/04/KAIWEETS-HT100-Non-Contact-Voltage-Tester-Pen-and-KAIWEETS-VT500-Voltage-Tester_-12V-300V-Non-Contact-and-Contact-Voltage-Pen-with-NCV-review-The-Gadgeteer.png',
        ...
        {
            id: 3,
            img_1: 'https://t0.gstatic.com/images?q=tbn:ANd9GcTF-POJh2PmcJlErMrNVlLeDS3L7dCDJqGC5nnlznWxI61dd2R5',
        ...
        {
            id: 4,
            img_1: 'https://engineershub.co.in/wp-content/uploads/2021/01/Insulation-Tape.jpg',
        ...
        {
            id: 5,
            img_1: 'https://klipboard.io/wp-content/uploads/2021/12/Elec-Screwdriver-1024x576.png',
        ...
        {
            id: 6,
            img_1: 'https://klipboard.io/wp-content/uploads/2021/06/pexels-anete-lusina-4792499-1024x684.jpg',
        ...
        {
            id: 7,
            img_1: 'https://t1.gstatic.com/images?q=tbn:ANd9GcTknaM4cjzJ0QsLbHl-8CTLI5GsA0kvSStNUgr16aORcAmCWdY6',
        ...
        {
            id: 8,
            img_1: 'https://housing.com/news/wp-content/uploads/2023/04/This-EDC-utility-knife-transforms-the-same-blade-into-a-scraper-at-the-push-of-a-button-Yanko-Design.png',
    ...
    return (
        <Box id="portfolio" className="portfolio-Container  " sx={{ pt: 10 }}>
            <h5 style={{color:"white",marginTop:"90px",fontStyle: 'italic'}}>Recently added our store</h5>

            
            <h1 style={{color:"white",marginTop:"20px",fontStyle: 'italic'}}>Trending Products</h1>
            ...
            <Container className='' sx={{ py: 10 }}>
                ...
                <Box sx={{ flexGrow: 1 }}>
                    <Grid container spacing={{ xs: 2, md: 3, }} columns={{ xs: 4, sm: 8, md: 12 }}>
                        ...
                        {
                            portfolios.map(portfolio => <TrandingProduct key={portfolio.id} portfolio={portfolio}></TrandingProduct>)
                        }
