                ...
                >
                  ...
                  <div className='brands mt-3'>
                    ...
                    <div className="form-check align-items-center me-3">
                      ...
                      <label className="form-check-label fw-bold all text-white me-4 sharee-design" for="flexCheckDefault">
                      Electricdrill
                      </label>
                    </div>
                    <div className="form-check align-items-center me-5">
                      ...
                      <label className="form-check-label fw-bold all me-5  text-white sharee-design" for="flexCheckDefault">
                      Light
                      </label>
                    </div>
                    <div className="form-check align-items-center me-5">
                    ...
                    <div className="form-check align-items-center me-3">
                      ...
                      <label className="form-check-label fw-bold all me-4 text-white sharee-design" for="flexCheckDefault">
                        VoltageTester
                      </label>
                    </div>
                    <div className="form-check align-items-center me-5">
