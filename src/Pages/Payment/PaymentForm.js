...
<form onSubmit={handleSubmit(onSubmit)}>
  ...
  >
    <Grid item xs={4} sm={4} md={4} className="newform text-white">
      ...
      {/* <span className="text-white"> */}
        {errors.cus_name && <span  className="text-white">This field is required</span>}
        {/* </span> */}
    </Grid>
  ...
  <Button className="buttons-new mt-5" style={{background:"#032831",color:"white", marginBottom:"100px",padding:"10px 20px",fontSize:"20px"}} type="submit" sx={{ width: "50%" }}>
    Submit
  </Button>
