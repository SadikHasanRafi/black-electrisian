            ...
            <Container>
                ...
                <div className='row'>
                    <div className='col-lg-4'>
                     <div className='mt-5'>
                     <img  data-aos="zoom-in" height="330" width="350" src='https://t4.ftcdn.net/jpg/01/06/07/11/360_F_106071121_8BHLklbWHp2caRkEmA1xtvYtUtDy4kQ2.jpg' alt="" />
                     </div>
                    </div>
                    ...
                    <Col md={{ span: 8, offset: 2 }}>
                        <div className="login-form text-center shadow" style={{background:"black",borderRadius:"20px"}}>
                            ...
                            <div className='login-meta mt-4'>
                                <p className='text-white'>New to Black Electrician <Link to={'/register'}><span className='login-links' style={{color:"#46AADC"}}>Create a free Account</span></Link></p>
