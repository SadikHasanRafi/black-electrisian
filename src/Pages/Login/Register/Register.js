            ...
            <Row>
              <div className='row'>
                <div className='col-lg-4'>
                    <div className='mt-5'>
                    <img  data-aos="zoom-in" height="380" width="350" src='https://t4.ftcdn.net/jpg/01/06/07/11/360_F_106071121_8BHLklbWHp2caRkEmA1xtvYtUtDy4kQ2.jpg' alt="" />
                    </div>
                ...
                <Col md={{ span: 8, offset: 2 }}>
                    <div className="login-form text-center shadow" style={{background:"black",borderRadius:"20px"}}>
                        <h2 className='mb-5  text-white'>Sign Up to Black Electrical</h2>
...
{/* <button className="btn-style" onClick={() => handleUpdate(cart._id)}>update</button> */}
                            ...
                            <button className='submit-all ms-3 me-5' type='submit'>Sign Up</button>
                        </form>
