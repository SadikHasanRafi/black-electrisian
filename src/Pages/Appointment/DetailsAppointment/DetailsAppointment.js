    ...
    return (
      ...
      <Container>
          <Box sx={{ textAlign: "center", my: 5 }}>
            <Typography variant="h4" style={{fontWeight:"600", color:"white"}}>Doctor Name : {book?.name}</Typography>
            <Typography variant="h5" style={{fontWeight:"600",color:"white"}}> Doctor Expertist : {book?.expert}</Typography>
          </Box>
              ...
              >
                <Box>
                  <span style={iconStyle}>
                    ...
                    <Typography variant="body1" style={{marginLeft:"10px",fontWeight:"600"}}> ProductName : {book?.name}</Typography>
                  </span>
                  <br />
                  <span style={iconStyle}>
                    <BorderColorIcon color="primary" />
