...
const Booking = ({booking,date}) => {
    ...
    const {name,time,space ,price,specialist,img,location,_id,expert}=booking
...
<Grid item xs={12} sm={6} md={4}>
        ...
        <Box sx={{ display: 'flex', justifyContent: '', marginTop:"10px" }}>
                  <a
                    // to={`/payment`}
                  ...
                  >
                    <NavLink 
                     ...
                     style={{padding:"10px 10px",textAlign:"",marginLeft:"-50px", borderRadius:"5px !important"}}
                    size="small">
                      Details
                    </NavLink>
                  </a>

                  <Button className='btn-style download-btn details-show ms-2' style={{padding:"8px 10px"}} onClick={handleOpen} variant="">Appointment</Button>
                  <Button className='btn-style download-btn details-show ms-2' style={{padding:"8px 10px"}} onClick={handleOpens} variant="">Review</Button>
        ...
        booking={booking}
        date={date}
        handleCloses={handleCloses} opens={opens}></BookingReview>
