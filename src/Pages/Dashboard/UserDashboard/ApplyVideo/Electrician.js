                    ...
                    <Col md={{ span: 8, offset: 2 }}>
                        <div className="login-form text-center shadow" style={{background:"#032831",borderRadius:"20px"}}>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                type="number"
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("ProductPrice", { required: true })} placeholder='Selary' /> <br />
                                ...
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("contact", { required: true })} placeholder='phone number' /> <br />
                                {/* <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                ...
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("address", { required: true })} placeholder='address' /> 
                               
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("experience", { required: true })} placeholder='example : year' /> 
