                    ...
                    <Col md={{ span: 8, offset: 2 }}>
                        <div className="login-form text-center shadow" style={{background:"#032831",borderRadius:"20px"}}>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                className='w-75 mb-3'  {...register("BlogName", { required: true })} placeholder='Blog Name' /> <br />
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
                                className='w-75 mb-3'  {...register("Equipment", { required: true })} placeholder='Blog Equipment' /> <br />
                                <input
                                style={{fontWeight:"600",color:" #0E1621"}}
