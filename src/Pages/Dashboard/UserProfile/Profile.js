          ...
          <Col md={9}>
            ...
            >
              <div className="single-box">
                ...
                <h6 className="text-white mt-2" style={{ textAlign: "" }}>
                  {" "}
                  Email : {user.email}
                </h6>
