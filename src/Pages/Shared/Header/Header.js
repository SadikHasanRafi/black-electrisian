...
const Header = () => {
    ...
    return (
        ...
        <div className='header-area'>
            <Navbar expand="lg"  bg="red" >
                ...
                {/* <img width='140' height='40' src='https://i.ibb.co/zQf4dd6/E-Krishi-BD-Transparent.png'></img> */}
                    <NavLink  to="/" className='logo mt-2'><span>Black-Electrical </span></NavLink>
      ...
      <Dropdown.Menu className='drop-menu'>
        {/* start  */}
        <Dropdown.Item className='down-color' href="/light">Light</Dropdown.Item>
        <Dropdown.Item className='down-color' href="/all-categories">all-categories</Dropdown.Item>
        <Dropdown.Item className='down-color' href="/Multimeter">Multimeter</Dropdown.Item>
        <Dropdown.Item className='down-color' href="/ElectricalDill">ElectricalDill</Dropdown.Item>
        <Dropdown.Item className='down-color' href="/fan">Fan</Dropdown.Item>
        <Dropdown.Item className='down-color' href="/robotics">Robotics</Dropdown.Item>
      ...
      <Dropdown.Menu className='drop-menu'>
        ...
        <Dropdown.Item className='down-color' href="/truck">Truck</Dropdown.Item>
                            ...
                            {/* <Nav.Link as={NavLink} to="/appointment" className='menu-item'>Appointment</Nav.Link> */}
                            <Nav.Link as={NavLink} to="/showElectrician" className='menu-item'>Electrician</Nav.Link>
                            <Nav.Link as={NavLink} to="/showBlogs" className='menu-item'>ShowBlogs</Nav.Link>
