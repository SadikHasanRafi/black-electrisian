...
<div className="footer-container data-foot">
            <div className="row">
                <div className="col-lg-3">
                    <div className="left-container text-start">
                        ...
                        <p className='mt-2'>The purpose of life is to live and let live. The societal living is possible when there are communal harmony and feeling of brotherhood among its members. The institutions of family and marriage contribute to the harmonious living in a society.Electrical equipment means any apparatus, appliance, cable, conductor, fitting, insulator, material, meter or wire that is used for controlling, generating, supplying, transforming.</p>
                            <p>
                               <h4>Contact-us</h4>
       ...
       <h5> Black-Electrical 2023. All rights reserved. Created by Black-Electrical.</h5>
