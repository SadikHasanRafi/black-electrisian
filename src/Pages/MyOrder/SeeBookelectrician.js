                        ...
                        service?.map((offers)=>(
                            ...
                            <div className="card" style={designShow}>
                                ...
                                <div class="card-body body-designs">
                                    ...
                                    <h6 class="card-text">BookingAddress: {offers?.useraddress}.</h6>
                                    <h6 className=" ">BookinguserOcupation:{offers?.ocupation}</h6>
                                    <h6 className=" ">BookinguserPhone:{offers?.userPhone}</h6>
                                    <h6 className="me-5 " >BookingUsercity:{offers?.city}</h6>
                                    <h6 className="me-5" >ElectricianName:{offers?.electricianName}</h6>
                                    <h6 className="me-5" >ElectricianContact:{offers?.contact}</h6>
                                    <h6 className="me-5" >ElectricianEmail:{offers?.userEmail}</h6>
                                    <h6 className="bg-danger text-white me-2 p-1 ">{offers?.positions}</h6>
